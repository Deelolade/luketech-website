...
export const metadata: Metadata = {
  ...
  title: {
    default: "Borehole Drilling Company in Lagos | Luketech Plumbing and Drilling Ltd",
    template: "%s | Luketech Plumbing and Drilling Ltd",
    },
  description: "Luketech Plumbing and Drilling Ltd offers professional borehole drilling, geophysical surveys, water exploration, borehole installation, pump systems, and maintenance services for homes, estates, farms, commercial, and industrial properties in Lagos and across Nigeria.",
  keywords: [
     ...
     images: [
       {
         ...
         height: 630,
         alt:
           "Luketech Plumbing and Drilling Ltd - Professional Borehole Drilling and Water Solutions",
       },
     ],
   },
